...
public class PeriodosController implements Serializable {
    ...
    private Periodos current;
    private DataModel items = null;
    @EJB
    private jpa.com.PeriodosFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Periodos) getItems().getRowData();
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("PeriodosDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class PeriodosControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Periodos) {
                ...
                return getStringKey(o.getIdPERIODOS());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Periodos.class.getName());
            }
        }
