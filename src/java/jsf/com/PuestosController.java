...
public class PuestosController implements Serializable {
    ...
    @EJB
    private jpa.com.PuestosFacade ejbFacade;
    ...
    public static class PuestosControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Puestos) {
                ...
                return getStringKey(o.getIdPUESTOS());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Puestos.class.getName());
            }
        }
